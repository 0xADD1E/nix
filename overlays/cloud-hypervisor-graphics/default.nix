# Adapted from https://spectrum-os.org/git/spectrum/tree/pkgs/cloud-hypervisor/default.nix
...
rec {
  cloud-hypervisor = prev.callPackage ./cloud-hypervisor-50.nix { };
  cloud-hypervisor-graphics = cloud-hypervisor.overrideAttrs (oldAttrs: rec {
